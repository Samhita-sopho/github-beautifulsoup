...
class TopProjects:
     ...
     def getTopProjects(self):
          print("trying to get")
          if self.error_message=="Not Available":
               return
          if self.error_message=="Clear":
               ...
               for i in range(0,noOfProjects):
                    ...
                    for j in range(0,len(dictContrib)):
                         tempD={"cname":"","ccount":0}
                         print(dictContrib[j]["login"])
                         print(dictContrib[j]["contributions"])
     ...
     def printTopProjects(self):
          if self.error_message=="Not Available":
               print("No projects available to print")
               return 
